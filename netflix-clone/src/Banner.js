        ...
        >
            <div className="banner__contents">
                <h1 className="banner__title">
                    ...
                    so if movie title doesnt exist tserach .name ...    and the ? is for if the movie is ever for any reason undefined, it will handle error elagantly and wont crash*/}
